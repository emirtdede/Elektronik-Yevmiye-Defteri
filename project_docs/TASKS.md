...
- [x] **Kategori 4 (Medya, QR ve Zaman Kısıtlamaları)**: Önizleme panellerini birleştirme ve Lightbox zoom entegrasyonu, QR kod modalı, jurnallerde sadece aynı gün düzenleme kısıtı ve yüklenen görsellerin WebP formatında sıkıştırılması.
